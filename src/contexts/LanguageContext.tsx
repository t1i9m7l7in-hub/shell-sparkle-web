...
const translations: Record<Language, Record<string, string>> = {
  'en': {
    ...
    'property.item1Title': "Shell Industrial Building, Hong Kong",
    ...
    'transportation.p1': "Since 1992 when the Group first invested in a joint venture to own and operate 200 taxis in Guangzhou, China, SMC has maintained a growing interest in the transportation business that provides stable income contribution.",
    'transportation.stat1Label': "Taxis in Fleet",
    'transportation.stat2Label': "Since",
    'transportation.stat3Label': "Eco-friendly Engines",
    'transportation.p2': "Currently, the Group owns 100% of Guangzhou SMC Car Rental Company Ltd. and operates a fleet of about 500 taxis, all equipped with environmental friendly engines. The Group's vision is to become one of the largest taxi rental companies in Guangzhou.",
    'transportation.stat1Number': '500+',
    'transportation.stat2Number': '1992',
    'transportation.stat3Number': '100%',
  ...
  'zh-TW': {
    ...
    'nav.property': "房地產",
    'nav.transportationBusiness': "運輸業務",
    'property.title': "房地產",
    'property.subtitle': "位於黃金地段的商業和工業物業",
    'property.intro': "集團的房地產投資組合包括位於中國大陸、香港和越南主要城市的商業和工業物業。該投資組合提供了穩定的租金收入和長期的資本增長前景。",
    'property.item1Title': "香港蜆殼工業大廈",
    'property.item1Desc': "蜆殼工業大廈建於1966年，是集團總部的所在地，總建築面積約為12,000平方米。",
    'property.item2Title': "中國廣州中信廣場",
    'property.item2Desc': "這座80層高的甲級辦公大樓，連同兩棟38層的公寓樓和一個40,000平方米的購物商場，交通便利，毗鄰天河區的廣州東站直通車總站。中信廣場是華南地區最著名的地標之一。",
    'transportation.title': "運輸業務",
    'transportation.subtitle': "廣州出租車車隊營運",
    'transportation.company': "廣州蜆殼汽車租賃有限公司",
    'transportation.ownership': "全資附屬公司",
    'transportation.p1': "自1992年集團首次投資合資企業在中國廣州擁有並營運200輛出租車以來，SMC在運輸業務方面保持著持續增長的興趣，為集團提供穩定的收入貢獻。",
    'transportation.stat1Label': "車隊規模",
    'transportation.stat2Label': "起始年份",
    'transportation.stat3Label': "環保引擎",
    'transportation.p2': "目前，集團擁有廣州蜆殼汽車租賃有限公司100%的股權，並營運一支約500輛出租車的車隊，所有車輛均配備環保引擎。集團的願景是成為廣州最大的出租車租賃公司之一。",
    'transportation.stat1Number': '500+',
    'transportation.stat2Number': '1992',
    'transportation.stat3Number': '100%',
  ...
  'zh-CN': {
    ...
    'nav.property': "房地产",
    'nav.transportationBusiness': "运输业务",
    'property.title': "房地产",
    'property.subtitle': "位于黄金地段的商业和工业物业",
    'property.intro': "集团的房地产投资组合包括位于中国大陆、香港和越南主要城市的商业和工业物业。该投资组合提供了稳定的租金收入和长期的资本增长前景。",
    'property.item1Title': "香港蚬壳工业大厦",
    'property.item1Desc': "蚬壳工业大厦建于1966年，是集团总部的所在地，总建筑面积约为12,000平方米。",
    'property.item2Title': "中国广州中信广场",
    'property.item2Desc': "这座80层高的甲级办公大楼，连同两栋38层的公寓楼和一个40,000平方米的购物商场，交通便利，毗邻天河区的广州东站直通车总站。中信广场是华南地区最著名的地标之一。",
    'transportation.title': "运输业务",
    'transportation.subtitle': "广州出租车车队营运",
    'transportation.company': "广州蚬壳汽车租赁有限公司",
    'transportation.ownership': "全资附属公司",
    'transportation.p1': "自1992年集团首次投资合资企业在中国广州拥有并营运200辆出租车以来，SMC在运输业务方面保持着持续增长的兴趣，为集团提供稳定的收入贡献。",
    'transportation.stat1Label': "车队规模",
    'transportation.stat2Label': "起始年份",
    'transportation.stat3Label': "环保引擎",
    'transportation.p2': "目前，集团拥有广州蚬壳汽车租赁有限公司100%的股权，并营运一支约500辆出租车的车队，所有车辆均配备环保引擎。集团的愿景是成为广州最大的出租车租赁公司之一。",
    'transportation.stat1Number': '500+',
    'transportation.stat2Number': '1992',
    'transportation.stat3Number': '100%',
